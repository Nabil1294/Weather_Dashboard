...
var weatherApiKey = '32ff6ffa3ef87acad2ff5e9a0c33c656';
...
function  renderForecast(dailyForecast){
    // clearing input for new city search
...
// function to display search history each in a button
...
// function to get lat and lon from data of city
function fetchCoords(data) {
    // variables to store lat & lon
    var lat = data[0].lat;
    var lon = data[0].lon;
...
// function to check if history search element was clicked or not
...
// functions to buttons clickable and run the program
getStorage();
